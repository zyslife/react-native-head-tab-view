export default {
    ...
    Page2Data: [
        { image: require('../resource/img11.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img12.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img13.jpeg'), height: 100, text: '这里是测试文字1', directory: 'right', imgSize: 80 },
        { image: require('../resource/img11.jpeg'), height: 100, text: '这里是测试文字1', directory: 'right', imgSize: 80 },
        { image: require('../resource/img12.jpeg'), height: 100, text: '这里是测试文字1', directory: 'right', imgSize: 80 },
        { image: require('../resource/img14.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img11.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img12.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img15.jpeg'), height: 100, text: '这里是测试文字1', directory: 'right', imgSize: 80 },
        { image: require('../resource/img11.jpeg'), height: 100, text: '这里是测试文字1', directory: 'right', imgSize: 80 },
        { image: require('../resource/img12.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img13.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img11.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img12.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img14.jpeg'), height: 100, text: '这里是测试文字1', directory: 'left', imgSize: 80 },
        { image: require('../resource/img11.jpeg'), height: 100, text: '这里是测试文字1', directory: 'right', imgSize: 80 },
