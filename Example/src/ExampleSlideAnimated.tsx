...
export default class ExampleSlideAnimated extends React.PureComponent<any, EState> {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#FFF' }}>
                ...
                <TabView
                    ...
                    headerRespond={true}
                    slideAnimated={this.state.slideAnimated}
                />
...
class Page2 extends React.PureComponent<any, State> {
    ...
    _scrollToTop = () => {
        this.mFlatlist && this.mFlatlist.getNode().scrollToOffset({ offset: 0 })
    }
    render() {
...
class Page3 extends React.PureComponent<any, State> {
    ...
    _scrollToTop = () => {
        this.listview && this.listview.getNode().scrollToLocation({ itemIndex: 0, sectionIndex: 0, viewOffset: 0 })
    }
