...
import { SlideSceneContainerType, SlideSceneContainerProps, NormalSceneContainerType, NormalSceneContainerProps } from './types'
...
export default function HPageViewHoc<T>(WrappedComponent: any) {
    ...
    return React.forwardRef((props: SlideSceneContainerType<any> | NormalSceneContainerType<any>, ref) => {
        ...
        return <NormalSceneContainer {...mProps as NormalSceneContainerProps<any>} />;
    });
}
